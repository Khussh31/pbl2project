...
public class Home extends JFrame{
	...
	this.username = username;
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/gym.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1300, 1020,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 1300, 1020); 
        add(NewLabel);
        
        JLabel l1 = new JLabel("Gym Management System");
