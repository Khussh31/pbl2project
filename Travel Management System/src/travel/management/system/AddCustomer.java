...
public class AddCustomer extends JFrame {
	...
	public AddCustomer(String username) throws SQLException {
		...
		t7.setColumns(10);
                ...
                JLabel l2 = new JLabel("Member_Id :");
		...
		JLabel lblmem = new JLabel("Joining Date :");
		lblmem.setBounds(35, 270, 200, 14);
		...
		t3.setColumns(10);
                ...
                JLabel lblenddate = new JLabel("Membership Ending On  :");
		lblenddate.setBounds(35, 390, 200, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s2 =  t1.getText(); //membership_id
	    			String s3 =  t2.getText();//name
                                String s4 =  radio;//gender
	    			String s5 =  t3.getText();  //joiningdate
                                String s10 = t8.getText(); //endmembershipdate
	    			String s7 =  t5.getText();  //address
                                String s8 =  t6.getText(); // phone_number
                                
                                
                                try {
                                    Class.forName("com.mysql.cj.jdbc.Driver");  
                                    conn =DriverManager.getConnection("jdbc:mysql:///gms","root","khush");
                                } catch (Exception e1) {
