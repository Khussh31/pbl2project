...
public class UpdateCustomer extends JFrame {
	...
	public UpdateCustomer(String username) throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/3.jpg"));
		...
		JLabel lblCountry = new JLabel("Joining Date :");
		...
		JLabel lblReserveRoomNumber = new JLabel("End of Membership :");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s3 =  t3.getText();
                                String s5 =  t5.getText();//gender
	    			String s6 =  t6.getText();
	    			String s7 =  t7.getText(); 
                                String s8 =  t8.getText();
                                String s9 = t9.getText(); 
                                
                                String q1 = "update customer set id= '"+s2+"', name = '"+s3+"', gender = '"+s5+"', joining_date= '"+s6+"', end_of_mem = '"+s7+"', address = '"+s8+"', phone = '"+s9+"' where username = '"+s1+"'";
